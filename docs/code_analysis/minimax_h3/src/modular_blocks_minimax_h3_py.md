...
# modular_blocks_minimax_h3.py

**原始文件**: src/diffusers/modular_pipelines/minimax_h3/modular_blocks_minimax_h3.py

**仓库**: [huggingface/diffusers](https://github.com/huggingface/diffusers)
