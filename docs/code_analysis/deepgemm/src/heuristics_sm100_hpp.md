...
tags:
  ...
  - LLM Inference
---
# heuristics/sm100.hpp

**原始文件**: `csrc/jit_kernels/heuristics/sm100.hpp`

**仓库**: [csrc/jit_kernels/heuristics/sm100.hpp](https://github.com/deepseek-ai/DeepGEMM/blob/88965b0/csrc/jit_kernels/heuristics/sm100.hpp)
