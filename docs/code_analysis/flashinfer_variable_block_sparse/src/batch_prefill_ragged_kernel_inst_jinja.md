...
tags:
  ...
  - Sparse Attention
---
# data/csrc/batch_prefill_ragged_kernel_inst.jinja

**原始文件**: `refs/codes/flashinfer_variable_block_sparse/variable_block_attn/data/csrc/batch_prefill_ragged_kernel_inst.jinja`
